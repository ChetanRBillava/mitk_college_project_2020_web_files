...
if($res->num_rows >0){
	...
	while ($row=$res->fetch_assoc()) {
		...
		$response['m_details']=$row['m_details'];
...
$trans_date_query="SELECT * FROM payment WHERE email='".$email."' and payment_for ='Mess bill'  order by pid DESC LIMIT 1";
